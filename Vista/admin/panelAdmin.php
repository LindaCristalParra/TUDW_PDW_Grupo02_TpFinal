...
<div class="container mt-4">
    ...
    <div class="list-group mt-3">
        ...
        <a href="/TUDW_PDW_Grupo02_TpFinal/Vista/Estructura/Accion/Compra/listado.php" class="list-group-item list-group-item-action">Mis ventas / Listado de compras</a>
        <a href="/TUDW_PDW_Grupo02_TpFinal/Vista/Estructura/Accion/Compra/listado.php?soloVentas=true" class="list-group-item list-group-item-action">Ventas (solo ventas)</a>
    </div>
</div>
